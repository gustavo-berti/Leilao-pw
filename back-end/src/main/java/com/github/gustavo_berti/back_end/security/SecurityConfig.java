    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/images/auction/*").permitAll()
                        ...
                        .requestMatchers("/api/people/upload-avatar").hasAnyRole("BUYER", "SELLER", "ADMIN")
                        ...
                        .requestMatchers("/api/payment/**").hasAnyRole("BUYER", "SELLER", "ADMIN")
                        .requestMatchers("/api/auctions/**").hasAnyRole("BUYER", "SELLER", "ADMIN")
                        .requestMatchers("/api/auctions/update").hasAnyRole("SELLER", "ADMIN")
                        .requestMatchers("/api/auctions/*").hasAnyRole("SELLER", "ADMIN")
